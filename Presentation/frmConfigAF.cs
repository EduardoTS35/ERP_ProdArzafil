...
{
    public partial class frmConfigAF : Form
    {
        ...
        public void MostrarDatos()
        {
            ...
            {
                dataGridView1.DataSource = userModel.MostrarBolsas("9");
                statusBolsa = 9;
            }
            else if (cmbSeleccion.Text == "Salidas")
            {
                dataGridView1.DataSource = userModel.MostrarBolsas("10");
                statusBolsa = 10;
            }
            else if (cmbSeleccion.Text == "Salidas Sucursales")
            {
                dataGridView1.DataSource = userModel.MostrarBolsas("11");
                statusBolsa = 11;
            }
        }
        ...
        public void DeshacerMovimiento()
        {
            if (statusSeleccion == true)
            {
                try
                {
                    if (cmbSeleccion.Text == "Salidas Sucursales")
                    {
                        userModel.ActualizarStatusBolsa(tboxIdBolsa.Text, Convert.ToString(statusBolsa - 2));
