...
{
    public partial class frmEntradaAF : Form
    {
        ...
        public void MostrarEntradasAF()
        {
            try
            {
                dataGridView1.DataSource = userModel.MostrarEntradasAF();
            }
            catch (Exception ex)
            {
        ...
        public void MostrarDatosBolsa(string ID)
        {
            try
            {
                dataGridView2.DataSource = userModel.MostrarBolsaAF(ID);
            }
            catch (Exception)
            {
        ...
        {
            userModel.InsertarEntradasAF(IdBolsa, NumPedido, IdHilo, IdColor, LoteHilatura, LoteT, IdCaja, PesoBruto, PesoNeto, NumConos, "9", Malla, ColorCono);
        }
