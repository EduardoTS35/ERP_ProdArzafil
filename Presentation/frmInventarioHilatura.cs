...
{
    public partial class frmInventarioHilatura : Form
    {
        public frmInventarioHilatura()
        {
            InitializeComponent();
        }

        private void frmInventarioHilatura_Load(object sender, EventArgs e)
        {
