...
{
    public partial class frmProductoEnProcesoAF : Form
    {
        int statusProceso = 11;
        public frmProductoEnProcesoAF()
        {
            InitializeComponent();
        }

        private void frmProductoEnProcesoAF_Load(object sender, EventArgs e)
        {
            getReport();
            getReportD();
