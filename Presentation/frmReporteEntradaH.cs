...
{
    public partial class frmReporteEntradaH : Form
    {
        public frmReporteEntradaH()
        {
            InitializeComponent();
        }

        private void frmReporteEntradaH_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenEntH(startDate, endDate);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesEntH(startDate, endDate);
