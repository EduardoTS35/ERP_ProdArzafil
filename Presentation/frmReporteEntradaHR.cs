...
{
    public partial class frmReporteEntradaHR : Form
    {
        int statusProceso = 7;
        public frmReporteEntradaHR()
        {
            InitializeComponent();
        }

        private void frmReporteEntradaHR_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenBolsaT(startDate, endDate, statusProceso);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesBolsaT(startDate, endDate, statusProceso);
