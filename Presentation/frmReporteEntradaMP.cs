...
{
    public partial class frmReporteEntradaMP : Form
    {
        public frmReporteEntradaMP()
        {
            InitializeComponent();
        }

        private void frmReporteEntradaMP_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenEntMP(startDate, endDate);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesEntMP(startDate, endDate);
