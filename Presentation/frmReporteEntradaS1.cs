...
{
    public partial class frmReporteEntradaS1 : Form
    {
        int statusProceso = 12;
        public frmReporteEntradaS1()
        {
            InitializeComponent();
        }

        private void frmReporteEntradaS1_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenBolsaAF(startDate, endDate, statusProceso);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesBolsaAF(startDate, endDate, statusProceso);
