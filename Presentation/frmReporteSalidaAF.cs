...
{
    public partial class frmReporteSalidaAF : Form
    {
        public frmReporteSalidaAF()
        {
            InitializeComponent();
        }

        private void frmReporteSalidaAF_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenBolsaSAF(startDate, endDate);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesBolsaSAF(startDate, endDate);
