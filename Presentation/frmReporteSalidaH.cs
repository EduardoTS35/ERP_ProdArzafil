...
{
    public partial class frmReporteSalidaH : Form
    {
        public frmReporteSalidaH()
        {
            InitializeComponent();
        }

        private void frmReporteSalidaH_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenSalH(startDate, endDate);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesSalH(startDate, endDate);
