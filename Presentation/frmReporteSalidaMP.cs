...
{
    public partial class frmReporteSalidaMP : Form
    {
        public frmReporteSalidaMP()
        {
            InitializeComponent();
        }

        private void frmReporteSalidaMP_Load(object sender, EventArgs e)
        {
        ...
        private void getReport(DateTime startDate, DateTime endDate)
        {
            ...
            reporte.GetOrderResumenSalMP(startDate, endDate);
        ...
        private void getReportD(DateTime startDate, DateTime endDate)
        {
            ...
            reporteD.GetOrderDetallesSalMP(startDate, endDate);
