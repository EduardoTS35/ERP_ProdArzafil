...
{
    public partial class frmReporteSalidaS2 : Form
    {
        int statusProceso = 15;
        public frmReporteSalidaS2()
        {
            InitializeComponent();
        }

        private void frmReporteSalidaS2_Load(object sender, EventArgs e)
        {
